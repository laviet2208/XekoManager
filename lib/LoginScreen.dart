                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        Padding(
                          padding: EdgeInsets.only(left: (screenWidth/4 - (screenWidth/4)/5)/2,right: (screenWidth/4 - (screenWidth/4)/5)/2,top: 10),
                          child: Container(
                        ...
                        Padding(
                          padding: EdgeInsets.only(left: 10,right: 10),
                          child: ButtonType1(Height: 50, Width: 600, color: Colors.redAccent, radiusBorder: 10, title: 'Đăng nhập', fontText: 'arial', colorText: Colors.white,
                            onTap: () async {
                               setState(() {
                                 loading = true;
                               });
