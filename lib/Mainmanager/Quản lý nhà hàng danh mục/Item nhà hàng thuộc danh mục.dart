...
class Itemnhahangtrongdanhmuc extends StatefulWidget {
  final double width;
  final String id;
  final Color color;
  final VoidCallback delete;
  const Itemnhahangtrongdanhmuc({Key? key, required this.width, required this.id, required this.color, required this.delete}) : super(key: key);

  @override
  State<Itemnhahangtrongdanhmuc> createState() => _ItemnhahangtrongdanhmucState();
}

class _ItemnhahangtrongdanhmucState extends State<Itemnhahangtrongdanhmuc> {
