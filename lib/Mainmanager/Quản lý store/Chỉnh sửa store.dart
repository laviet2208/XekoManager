...
class Chinhsuastore extends StatefulWidget {
  final double width;
  final double height;
  final accountShop shop;
  const Chinhsuastore({Key? key, required this.width, required this.height, required this.shop}) : super(key: key);

  @override
  State<Chinhsuastore> createState() => _ChinhsuashopState();
}

class _ChinhsuashopState extends State<Chinhsuastore> {
