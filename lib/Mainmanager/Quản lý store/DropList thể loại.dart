...
class Droplistcuahang extends StatefulWidget {
  final double width;
  final accountShop shop;
  const Droplistcuahang({Key? key, required this.width, required this.shop}) : super(key: key);

  @override
  State<Droplistcuahang> createState() => _DroplistnhahangState();
}

class _DroplistnhahangState extends State<Droplistcuahang> {
  int selectIndex = 0;
