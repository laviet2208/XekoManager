...
class ITEMdanhmucshop extends StatelessWidget {
  ...
  const ITEMdanhmucshop({Key? key, required this.width, required this.height, required this.updateEvent, required this.directory, required this.shopList}) : super(key: key);
  ...
  Future<void> pushData() async{
    try {
      DatabaseReference databaseRef = FirebaseDatabase.instance.reference();
      await databaseRef.child('StoreDirectory/' + directory.id).set(directory.toJson());
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: Padding(
                ...
                child: AutoSizeText(
                  directory.shopList.length.toString() + ' Cửa Hàng',
                  style: TextStyle(
                      fontFamily: 'Roboto',
                      fontWeight: FontWeight.normal,
                      color: Colors.black,
              ...
              onTap: () async {
                showDialog(
                    ...
                    builder: (BuildContext context) {
                      return AlertDialog(
                        title: Text('Add cửa hàng mới vào danh mục'),
                        content: Container(
