...
import 'package:xekomanagermain/Mainmanager/Qu%E1%BA%A3n%20l%C3%BD%20nh%C3%A0%20h%C3%A0ng/Danh%20s%C3%A1ch%20m%C3%B3n%20%C4%83n/S%E1%BB%ADa%20m%C3%B3n.dart';
  ...
  Widget build(BuildContext context) {
    ...
    Future<void> deleteRequest(String id) async {
      try {
        ...
        await databaseRef.child('Food/' + id).remove();
                ...
                child: ListView(
                  ...
                  children: [
                        ...
                        showDialog(
                            ...
                            builder: (BuildContext context) {
                              return AlertDialog(
                                ...
                                content: Suamonan(shop: product.owner, product: product),
                              );
                            }
                        );
                      },
                    ...
                    GestureDetector(
                      ...
                      onTap: () async {
                        deleteImage('Food/'+product.id+'.png');
