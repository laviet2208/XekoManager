...
import 'package:xekomanagermain/Mainmanager/Qu%E1%BA%A3n%20l%C3%BD%20%C4%91i%E1%BB%81u%20kho%E1%BA%A3n/Th%C3%AAm%20%C4%91i%E1%BB%81u%20kho%E1%BA%A3n.dart';

import 'Item điều khoản.dart';
import 'Policy.dart';

class Quanlydieukhoan extends StatefulWidget {
  final double width;
  final double height;
  const Quanlydieukhoan({Key? key, required this.width, required this.height}) : super(key: key);

  @override
  State<Quanlydieukhoan> createState() => _QuanlydieukhoanState();
}

class _QuanlydieukhoanState extends State<Quanlydieukhoan> {
            ...
            child: Container(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return Itemdieukhoan(width: widget.width, height: 120, policy: policyList.reversed.toList()[index],color: (index % 2 == 0) ? Colors.white : Color.fromARGB(255, 247, 250, 255),);
                },
              ),
            ),
          )
