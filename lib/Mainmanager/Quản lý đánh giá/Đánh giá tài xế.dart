...
import 'package:xekomanagermain/Mainmanager/Qu%E1%BA%A3n%20l%C3%BD%20%C4%91%C3%A1nh%20gi%C3%A1/Item%20%C4%91%C3%A1ng%20gi%C3%A1%20t%C3%A0i%20x%E1%BA%BF.dart';
import 'package:xekomanagermain/dataClass/FinalClass.dart';

import '../Quản lý khu vực và tài khoản admin/Area.dart';
import 'Evaluate.dart';

class Danhgiataixe extends StatefulWidget {
  final double width;
  final double height;
  const Danhgiataixe({Key? key, required this.width, required this.height}) : super(key: key);

  @override
  State<Danhgiataixe> createState() => _DanhgiataixeState();
}

class _DanhgiataixeState extends State<Danhgiataixe> {
            ...
            child: Container(
              ...
              child: (chosenList.length == 0) ? Text('Danh sách trống') : ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return Itemdanhgiataixe(width: widget.width, height: 120, evaluate: chosenList[index], color: (index % 2 == 0) ? Colors.white : Color.fromARGB(255, 247, 250, 255) ,);
                  }
              ),
            ),
          )
