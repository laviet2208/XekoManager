        ...
        children: [
                    ...
                    child: RichText(
                      text: TextSpan(
                        ...
                        children: <TextSpan>[
                          ...
                          TextSpan(
                            text: widget.order.productList[0].owner.name, // Phần còn lại viết bình thường
                            style: TextStyle(
                              fontSize: 16,
                              fontFamily: 'arial',
                              fontWeight: FontWeight.normal, // Để viết bình thường
                    ...
                    child: RichText(
                      text: TextSpan(
                        ...
                        children: <TextSpan>[
                          ...
                          TextSpan(
                            text: dataCheckManager.getStringNumber(widget.order.shipcost).toString() + ' VNĐ',
                            style: TextStyle(
                              fontSize: 16,
                              fontFamily: 'arial',
                              fontWeight: FontWeight.normal, // Để viết bình thường
          ...
          Container(
            ...
            child: Padding(
                padding: EdgeInsets.only(left: 10, right: 10),
                child: Text(
                  widget.order.startTime.hour.toString() + " : " + widget.order.startTime.minute.toString() + " : " + widget.order.startTime.second.toString() + " ngày " + widget.order.startTime.day.toString() + "/" + widget.order.startTime.month.toString() + "/" + widget.order.startTime.year.toString(),
                  style: TextStyle(
                    fontSize: 18, 
                    fontFamily: 'arial',
                    fontWeight: FontWeight.normal, // Để in đậm
